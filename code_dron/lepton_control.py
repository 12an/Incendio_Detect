...
class Lepton:
    def __init__(self):
        ...
        try:
            a = self.lep.agc.GetEnableState()
            self.lep.agc.GetEnableStateChecked()
            self.lep.agc.SetEnableState(a)
            a = self.lep.rad.GetEnableState()
            self.lep.rad.GetEnableStateChecked()
            self.lep.rad.SetEnableState(a)
            b = self.lep.rad.GetTLinearEnableState()
            self.lep.rad.GetTLinearEnableStateChecked()
            self.lep.rad.SetTLinearEnableState(b)
            self.tlinear = True
        except:
            print("Thivvvvs lepton does not support tlinear")
            self.tlinear = False            
